...
namespace RadiologiaAppNew.ViewModels.Apparecchiature
{
    public class ApparecchiaturaListViewModel
    {
        ...
        public string? TipologiaFiltro { get; set; }  // nuovo — sostituisce RepartoFiltro
        ...
        // Dati per i filtri (mantenuto per retrocompatibilità Detail)
        ...
        public bool HaFiltriAttivi =>
            ...
            !string.IsNullOrEmpty(TipologiaFiltro);
    }
