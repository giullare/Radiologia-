...
builder.Entity<Costruttore>().HasData(
    new Costruttore { Id = 1, Nome = "Siemens Healthineers",
        Paese = "Germania", Attivo = true },
    new Costruttore { Id = 2, Nome = "GE HealthCare",
        Paese = "USA", Attivo = true },
    new Costruttore { Id = 3, Nome = "Philips Healthcare",
        Paese = "Paesi Bassi", Attivo = true },
    new Costruttore { Id = 4, Nome = "Canon Medical Systems",
        Paese = "Giappone", Attivo = true },
    new Costruttore { Id = 5, Nome = "Hologic",
        Paese = "USA", Attivo = true },
    new Costruttore { Id = 6, Nome = "Varex Imaging",
        Paese = "USA", Attivo = true }
);
           ...
           builder.Entity<Sito>(e =>
{
    ...
    e.HasMany(x => x.Immobili)
        ...
        .OnDelete(DeleteBehavior.Cascade); // ← era Restrict
});
    ...
    e.HasMany(x => x.Locali)
        ...
        .OnDelete(DeleteBehavior.Cascade); // ← era Restrict
            ...
            builder.Entity<ProtocolloVerifica>(e =>
            {
                ...
                e.Property(x => x.Descrizione).IsRequired().HasMaxLength(500);
            ...
            builder.Entity<Verbale>(e =>
            {
                e.HasKey(x => x.Id);
    e.Property(x => x.Id)
     .ValueGeneratedOnAdd();  // ← AGGIUNGERE

                e.HasMany(x => x.FileAllegati)
                    .WithOne(x => x.Verbale)
                    .HasForeignKey(x => x.VerbaleId)
                    .OnDelete(DeleteBehavior.NoAction);
            });
     ...
     .ValueGeneratedOnAdd();  // ← AGGIUNGERE
            ...
            builder.Entity<ProtocolloVerifica>().HasData(
                ...
                new ProtocolloVerifica
                {
                    ...
                    Tipo = TipoProtocollo.PrimaVerificaEdr,
